...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-2.33-kirby-problem-2.33-9e1feca7-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-2.33"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-2.33-kirby-problem-2.33-9e1feca7-v1",
      "problem_contract_sha256": "920945a125ebf486d59b486e557844d4a7538bc0e41d836be75b6052d4a4453f",
      "problem_id": "problem:um-kp-2.33-kirby-problem-2.33-9e1feca7",
      "route_id": "route:um-kp-2.33-kirby-problem-2.33-9e1feca7-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-2.33-kirby-problem-2.33-9e1feca7-source-fidelity-01",
      "graph_id": "graph:um-kp-2.33-kirby-problem-2.33-9e1feca7-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-2.33-kirby-problem-2.33-9e1feca7-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-2.33-kirby-problem-2.33-9e1feca7-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $S$ be a closed compact surface (without boundary). Is there a finitely generated, torsion-free group $G$ such that $G$ cannot act faithfully by homeomorphisms on $S$?"
          },
          "statement_sha256": "90a5d182db27b7de3bf06af876e136e93a03e43905fe6cb0b7e3704fdcc03865"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-2.33-kirby-problem-2.33-9e1feca7-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-2.33-kirby-problem-2.33-9e1feca7-root",
      "route_id": "route:um-kp-2.33-kirby-problem-2.33-9e1feca7-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-2.33-b692ca07f96d",
        "url": "https://www.unsolvedmath.com/problems/KP-2.33"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
